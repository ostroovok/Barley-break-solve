...
namespace BFSearchExample
{
    ...
    /// </summary>
    public sealed class FastPriorityQueue<TState> where TState : State
    {
        private TState[] _nodes;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Contains(TState node) => _nodes[node.QueueIndex] == node;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Enqueue(TState node, double priority)
        {
            if (_nodes.Length <= Count + 1)
            {
                var newNodes = new TState[_nodes.Length * 2];
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void UpdatePriority(TState node, double priority)
        {
            node.H = (int)priority;
            OnNodeUpdated(node);
        }
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void Remove(TState node)
        {
            //If the node is already the last node, we can remove it immediately
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private void CascadeUp(TState node)
        {
            //aka Heapify-up
            int parent;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private void CascadeDown(TState node)
        {
            //aka Heapify-down
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private bool HasHigherPriority(TState higher, TState lower) => higher.H < lower.H;
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private bool HasHigherOrEqualPriority(TState higher, TState lower) => higher.H <= lower.H;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private void OnNodeUpdated(TState node)
        {
